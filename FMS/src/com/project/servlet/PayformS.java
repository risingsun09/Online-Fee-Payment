...
/**
 * Servlet implementation class PayformS
 */
@WebServlet("/PayformS")
public class PayformS extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<form action='PayStud.jsp' method='post'>");
		out.println("<font style='color:white'><br><h1>PAYMENT:</h1></font>");
		...
		out.print("<br/><input type='submit' name='submit' id='reg-btn' value='PAY NOW'/>");
		out.print("</form>");
		out.print("</div>");
		out.println("</body>");
		out.println("</html>");
