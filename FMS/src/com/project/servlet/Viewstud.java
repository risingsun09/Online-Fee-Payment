		...
		out.println("<div id='header'>");
				...
				out.println("<ul>");
						...
						out.println("<div id='container'>"
								...
								+ "<li class='selected'><a href='Viewstud'>Student Details</a></li>"
					...
					for(StudentBean bean:list){
						out.print("<tr><td>"+bean.getRollno()+"</td><td>"+bean.getName()+"</td><td>"+bean.getPassword()+"</td><td>"+bean.getEmail()+"</td><td>"+bean.getHostel()+"</td><td>"+bean.getCourse()+"</td><td>"+bean.getSem()+"</td><td>"+bean.getPaid()+"</td><td>"+bean.getAmt()+"</td><td>"+bean.getAddress()+"</td><td>"+bean.getContact()+"</td><td><a href='EditStudForm?rollno="+bean.getRollno()+"'>Update</a></td><td><a href='DelStud?rollno="+bean.getRollno()+"'>Delete</a></td></tr>");
					}
